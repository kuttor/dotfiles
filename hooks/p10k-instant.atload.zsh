...
() {
  ...
  typeset -g __p9k_instant_prompt_param_sig=$'1.20.5\C-A5.9\C-Azsh-5.9-0-g73d3173\C-A\C-AiTerm.app\C-A1\C-Aakuttor%\C-ADEBUG\C-A\C-A\C-A\C-A\C-A\C-A1\C-A0\C-A0\C-A\C-A%B%S%#%s%b\C-A1\C-AUTF-8\C-A\C-A\C-A0\C-A1\C-A/Users/akuttor/.local/share/zinit/zinit.git/plugins/romkatv---powerlevel10k\C-A\C-A\C-A\C-A\C-A1\C-A256\C-A0\C-Atrue'
  local gitstatus_dir=/Users/akuttor/.local/share/zinit/zinit.git/plugins/romkatv---powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/Users/akuttor/.local/p10k-akuttor
  ...
  local -A _p9k_display_k=(empty_line 1 1/left/dir 19 1/gap 15 -1/right/background_jobs 27 -1/left 11 -1 5 1/right/history 29 1/left 11 1/right/background_jobs 27 1/right_frame 9 -1/right_frame 9 -1/left/dir 19 -1/gap 15 1/left/vcs 21 1/right 13 1/right/time 31 1/right/status 23 -1/right/root_indicator 25 -1/right/time 31 -1/right 13 1/left/context 17 -1/right/status 23 -1/right/history 29 1/right/root_indicator 25 -1/left/context 17 1/left_frame 7 1 5 -1/left/vcs 21 ruler 3 -1/left_frame 7)
