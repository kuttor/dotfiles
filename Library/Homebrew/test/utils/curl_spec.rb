...
RSpec.describe "Utils::Curl" do
  ...
  let(:details) do
    ...
    details[:normal][:ok] = details[:normal][:no_cookie]
    details[:normal][:ok][:status_code] = "200"

    details[:normal][:single_cookie] = details[:normal][:no_cookie]
    details[:normal][:single_cookie][:headers]["set-cookie"] = "a_cookie=for_testing"

    details[:normal][:multiple_cookies] = details[:normal][:no_cookie]
    details[:normal][:multiple_cookies][:headers]["set-cookie"] = [
      "first_cookie=for_testing",
      "last_cookie=also_for_testing",
    ]

    details[:normal][:blank_headers] = details[:normal][:no_cookie]
    ...
    details[:cloudflare][:multiple_cookies] = details[:cloudflare][:single_cookie]
    ...
    details[:cloudflare][:no_server] = details[:cloudflare][:single_cookie]
    details[:cloudflare][:no_server][:headers].delete("server")

    details[:cloudflare][:wrong_server] = details[:cloudflare][:single_cookie]
    ...
    details[:incapsula][:single_cookie_visid_incap] = details[:normal][:no_cookie]
    details[:incapsula][:single_cookie_visid_incap][:headers]["set-cookie"] = "visid_incap_something=something"

    details[:incapsula][:single_cookie_incap_ses] = details[:normal][:no_cookie]
    details[:incapsula][:single_cookie_incap_ses][:headers]["set-cookie"] = "incap_ses_something=something"

    details[:incapsula][:multiple_cookies_visid_incap] = details[:normal][:no_cookie]
    ...
    details[:incapsula][:multiple_cookies_incap_ses] = details[:normal][:no_cookie]
